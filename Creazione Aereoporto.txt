...
-- Started on 2021-02-06 18:13:11
...
WHERE NEW."CodSlot" = B."CodSlot" AND B."TempoDiImbarcoEffettivo" > B."TempoDiImbarcoStimato" AND NEW."Data" = B."Data"
);
RETURN NULL;
END;
$$;
...
--
-- TOC entry 2908 (class 2606 OID 147660)
...
--
-- TOC entry 2900 (class 2606 OID 16631)
...
--
-- TOC entry 2906 (class 2606 OID 98441)
...
--
-- TOC entry 2898 (class 2606 OID 172702)
-- Name: Fedeltà Fedeltà_CentoKilometri_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Fedeltà"
    ADD CONSTRAINT "Fedeltà_CentoKilometri_key" UNIQUE ("CentoKilometri");


--
-- TOC entry 2904 (class 2606 OID 98426)
...
--
-- TOC entry 2902 (class 2606 OID 98443)
...
--
-- TOC entry 2910 (class 2606 OID 147680)
...
--
-- TOC entry 2924 (class 2620 OID 131260)
...
--
-- TOC entry 2921 (class 2620 OID 131264)
...
--
-- TOC entry 2927 (class 2620 OID 131266)
...
--
-- TOC entry 2926 (class 2620 OID 172243)
...
--
-- TOC entry 2922 (class 2620 OID 131268)
...
--
-- TOC entry 2925 (class 2620 OID 172242)
...
--
-- TOC entry 2929 (class 2620 OID 147672)
...
--
-- TOC entry 2928 (class 2620 OID 147671)
...
--
-- TOC entry 2923 (class 2620 OID 131191)
...
--
-- TOC entry 2930 (class 2620 OID 172244)
...
--
-- TOC entry 2917 (class 2606 OID 172680)
...
--
-- TOC entry 2918 (class 2606 OID 172685)
...
--
-- TOC entry 2916 (class 2606 OID 172670)
...
--
-- TOC entry 2915 (class 2606 OID 172645)
-- Name: Coda di imbarco Coda di imbarco_CodSlot_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Coda di imbarco"
    ADD CONSTRAINT "Coda di imbarco_CodSlot_fkey" FOREIGN KEY ("CodSlot") REFERENCES public."Slot"("CodSlot") ON DELETE SET NULL NOT VALID;


--
-- TOC entry 2912 (class 2606 OID 172695)
...
--
-- TOC entry 2911 (class 2606 OID 172690)
...
--
-- TOC entry 2914 (class 2606 OID 172655)
...
--
-- TOC entry 2913 (class 2606 OID 172675)
...
--
-- TOC entry 2919 (class 2606 OID 172660)
-- Name: Tratta Tratta_CodGate_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Tratta"
    ADD CONSTRAINT "Tratta_CodGate_fkey" FOREIGN KEY ("CodGate") REFERENCES public."Gate"("CodGate") ON DELETE SET NULL NOT VALID;


--
-- TOC entry 2920 (class 2606 OID 172665)
...
-- Completed on 2021-02-06 18:13:11
